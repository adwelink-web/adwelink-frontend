...
export default function DashboardLayout({
    ...
    return (
        <div className="flex h-screen bg-background overflow-hidden">
            {/* Desktop Sidebar */}
            <div className="hidden md:flex w-64 flex-col bg-sidebar border-r border-border">
                <AppSidebar />
            </div>
            ...
            <div className="flex flex-1 flex-col overflow-hidden">
                ...
                {/* Mobile Header */}
                <header className="flex h-16 items-center border-b border-border bg-background/50 backdrop-blur-md px-4 md:hidden">
